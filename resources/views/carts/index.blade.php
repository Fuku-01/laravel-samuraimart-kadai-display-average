...
<div class="container d-flex justify-content-center mt-3">
    <div class="w-75">
        ...
        <div class="d-flex justify-content-end mt-3">
            ...
            <!-- <div class="btn samuraimart-submit-button disable" data-bs-toggle="modal" data-bs-target="#buy-confirm-modal">購入を確定する</div> -->
            <button class="btn samuraimart-submit-button disable">購入に進む</button>
            @endif
